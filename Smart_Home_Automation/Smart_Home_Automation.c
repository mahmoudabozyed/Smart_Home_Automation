 ...
 *
 * Description: Application file for the Smart Home Automation system
 *              using ATmega32, LCD, Temperature Sensor, LDR, Flame Sensor,
 *              DC Motor, LEDs, and Buzzer.
 *              The system controls fan speed, lighting, and fire alarm
